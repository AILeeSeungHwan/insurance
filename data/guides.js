const guides = [
  ...
  {
    id: 'G0007',
    slug: 'silson-1gen-keepit',
    category: 'guide',
    guideType: 'explainer',
    title: '1세대 실손보험 절대 바꾸지 말아야 하는 이유 — 4세대 전환 권유 실제 사례와 세대별 보장 비교',
    description: '1세대 실손 보유자에게 4세대 전환을 권유하는 사례가 반복됩니다. 세대별 비급여 보장 구조 차이, 전환 시 실질 손해액 계산, 갱신 불가 허위 고지 사례를 실제 경험과 함께 공시 기준으로 정리합니다.',
    ymylLevel: 'B',
    publishedAt: '2026-05-14',
    updatedAt: '2026-05-14',
    tags: ['1세대실손', '4세대전환', '실손비교', '비급여'],
    relatedCategorySlug: 'silson',
    relatedToolSlugs: ['copayment', 'silson-premium'],
  },
  {
    id: 'G0008',
    slug: 'refund-insurance-exit-check',
    category: 'guide',
    guideType: 'explainer',
    title: '환급형 보험 해지 전 반드시 확인할 5가지 — 8년 보유 보험 해지 경험에서 배운 것',
    description: '환급형·저해지환급형 보험을 해지하기 전 반드시 점검해야 할 납입기간별 환급률, 손익분기점 구간, 감액납입·보험료 납입 유예 대안, 그리고 해지 후 재가입 리스크를 정리합니다.',
    ymylLevel: 'B',
    publishedAt: '2026-05-14',
    updatedAt: '2026-05-14',
    tags: ['환급형보험', '해지', '손익분기점', '저해지'],
    relatedCategorySlug: 'silson',
