const post = {
  ...
  "sections": [
    {
      "type": "intro",
      "html": "<p><strong>삼성화재해상보험</strong>은 손해보험 분야의 주요 회사로, 1952년에 설립되었습니다. 본 페이지는 금감원·손해보험협회 공시 자료를 기준으로 회사 개요, 재무건전성 지표, 주력 상품군, 청구 채널을 정리합니다.</p><p style=\"font-size:13px;color:#888;margin-top:12px\">※ 본 사이트는 이 보험사의 상품을 판매·모집하지 않습니다.</p>"
    },
    {
      "type": "toc"
    },
    ...
    {
      "type": "body",
      "html": "<ul><li>정식 명칭: 삼성화재해상보험</li><li>분류: 손해보험</li><li>설립: 1952년</li><li>공식 웹사이트: <a href=\"https://www.samsungfire.com\" target=\"_blank\" rel=\"noopener noreferrer\">https://www.samsungfire.com</a></li></ul>"
    },
    {
      "type": "h2",
      "id": "history",
    ...
    {
      "type": "body",
      "html": "<p>삼성화재해상보험은 한국 손해보험 시장에서 주요한 위치를 차지하는 회사로, 자산규모·가입자수·상품군 범위에서 상위권에 속합니다. 계열사 네트워크와 판매 채널(대면·방카·텔레·다이렉트)을 통해 다양한 고객층을 대상으로 서비스를 제공합니다.</p>"
    },
    {
      "type": "h2",
      "id": "soundness",
